...
/// </summary>
public class SparkSelectParser : Base.SqlTools.BaseSqlHelper
{
	/// <summary>
	...
	/// </remarks>
	public override string GetSqlPagination(string sql, int pageNumber, int pageSize) => $"{sql} LIMIT {pageSize}";

...
{ 
	...
	///		Crea la conexión
	/// </summary>
	protected override IDbConnection GetInstance() => new OdbcConnection(ConnectionString.ConnectionString);

	/// <summary>
	///		Obtiene un comando
	/// </summary>
	protected override DbCommand GetCommand(string text, TimeSpan? timeout = null) => new OdbcCommand(text, Connection as OdbcConnection);
	...
	{
		return await new Parser.SparkSchemaReader().GetSchemaAsync(this, options, timeout, cancellationToken);
	}

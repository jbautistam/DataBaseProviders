...
public class SqLiteProvider : DbProviderBase
{
	...
	///		Crea la conexión
	/// </summary>
	protected override IDbConnection GetInstance() => new SQLiteConnection(ConnectionString.ConnectionString);
	...
	{
		SQLiteCommand command = new(text, Connection as SQLiteConnection, Transaction as SQLiteTransaction);
